				...
				<form:form modelAttribute="personel" class="form-horizontal"
					...
					<div class="form-group">
						<table>
							<tr>
								<td>id</td>
								<td><form:input id="id" path="id" type="text"
							...
							<tr>
								<td>about</td>
								<td><form:textarea id="about" path="about" rows="2" /></td>
							</tr>
							<tr>
								<td>phoneModel</td>
								<td><form:checkboxes class="form-check-label" items="${phoneList}" path="phoneModel" /></td>
							</tr>
							<tr>
								<td></td>
